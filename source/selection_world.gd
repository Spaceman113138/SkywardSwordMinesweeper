...
@onready var tileScene = preload("res://source/selectiontile.tscn")
@onready var worldscene = preload("res://source/world.tscn")
@onready var UI:TopUI = get_node("CanvasLayer/UI")

var currentContents = []


func _ready() -> void:
	UI.connect("changeScene", changeScene)
	UI.connect("changeDifficulty", changeDifficutly)
...
func changeDifficutly(newDifficulty: String):
...
func changeScene():
	get_tree().change_scene_to_file("res://source/world.tscn")
