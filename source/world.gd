...
var scene = preload("res://source/tile.tscn")

var currentValue: float = 0

@onready var UI: TopUI = get_node("CanvasLayer/UI")
@onready var gameOverScreen: Control = get_node("CanvasLayer/gameOver")

@onready var selectionScene:PackedScene = preload("res://source/selection_world.tscn")
...
func changeScene():
	get_tree().change_scene_to_packed(selectionScene)
